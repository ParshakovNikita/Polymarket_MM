...
class BettingAPI:
    ...
    def __init__(self, path_to_args) -> None:
        ...
        self.SPORT = self.api_params["SPORT"]
    ...
    def update_odds(self) -> None:
        ...
        try:
            ...
            if odds_response.status_code != 200:
                ...
                self.odds.to_csv(f'database_files/NFL_odds_{datetime.now().date()}_{datetime.now().hour}.csv', index_label=False) # maybe move to polymarket_lib
